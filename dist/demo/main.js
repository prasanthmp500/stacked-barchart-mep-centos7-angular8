...
module.exports = "<div id=\"histogramHolder\"></div>\n"
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        // create the svg
        // set the dimensions and margins of the graph
        var margin = { top: 10, right: 20, bottom: 60, left: 60 }, width = 960 - margin.left - margin.right, height = 600 - margin.top - margin.bottom;
        var svg = d3__WEBPACK_IMPORTED_MODULE_1__["select"]("div#histogramHolder").append("svg")
        ...
        var y = d3__WEBPACK_IMPORTED_MODULE_1__["scaleLinear"]()
            .rangeRound([height, 0]);
        // set the colors
        var z = d3__WEBPACK_IMPORTED_MODULE_1__["scaleOrdinal"]()
        ...
        y.domain([0, d3__WEBPACK_IMPORTED_MODULE_1__["max"](data, function (d) { return d.total; })]).nice();
        z.domain(keys);
        g.append("g")
            .selectAll("g")
            .data(d3__WEBPACK_IMPORTED_MODULE_1__["stack"]().keys(keys)(data))
            .enter().append("g")
            ...
            var xPosition = d3__WEBPACK_IMPORTED_MODULE_1__["mouse"](this)[0] - 5;
            var yPosition = d3__WEBPACK_IMPORTED_MODULE_1__["mouse"](this)[1] - 5;
        ...
        g.append("g")
            .attr("class", "axis")
            .call(d3__WEBPACK_IMPORTED_MODULE_1__["axisLeft"](y).ticks())
            .append("text")
            .attr("x", 2)
...
module.exports = __webpack_require__(/*! /na-homes/prasanth/Desktop/tmp/src/main.ts */"./src/main.ts");
